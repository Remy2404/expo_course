      ...
      <View className="bg-white p-4 rounded-lg shadow-md w-full">
        ...
        <Pressable
          ...
          className={`p-3 rounded-md ${
            isPressed ? "bg-secondary" : "bg-primary"
          }`}
        >
        ...
        <Link
          href="/profile"
          className="text-blue-500 underline mt-2 justify-center items-center"
        >
          Go to Profile
        </Link>
        <Link
          href="/about"
          className="text-blue-500 underline mt-2 font-medium bold"
        >
          Go to Abouts
        </Link>
        <Link
